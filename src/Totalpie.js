...
const data01 = [{ name: 'Group A', value: 1481 }, { name: 'Group B', value: 44519 }]
    ...
    render() {
        return (
            <div>
                ...
                <a><i><font size="2">1,481 positive reports from 46,000* students and employees.</font></i></a>
                ...
                <ResponsiveContainer width={'100%'} height={"100%"} aspect={isMobile ? ('1.6') : ('2.5')}>
                    <PieChart margin={{ top: 0, left: 0, right: 0, bottom: 0 }} >
                        <Pie data={data01} innerRadius={80} outerRadius={120} fill="#8884d8" paddingAngle={5}>
                            <Label value="3.22%" position="centerBottom" className='label' fontSize='38px' />
                            ...
                            <Label value="Aug 1 - Sept 21" position="centerTop" className='label-bottom' fontSize='12px' />
                ...
                {/* past projections */}
                <a><font size="3">One week before Sept 21:<b> 2.78%</b></font></a>
                <br />
                <a><font size="3">Two weeks before Sept 21:<b> 2.05%</b></font></a>
