            ...
            <div>
                ...
                <Table aria-label="simple table">
                    ...
                    {otherRows.map((otherRows) => (
                        ...
                        <TableCell align="right">{otherRows.calories.toLocaleString()}</TableCell>
                        </TableRow>
                    ))}
                    </TableBody>
                </Table>
                ...
                <Table aria-label="simple table">
                    ...
                    {rows.map((row) => (
                        ...
                        <TableCell align="right">{row.calories.toLocaleString()}</TableCell>
                        <TableCell align="right">{row.fat.toLocaleString()}</TableCell>
                        </TableRow>
                    ))}
                    </TableBody>
                </Table>
