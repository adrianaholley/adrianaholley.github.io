    ...
    render() {
        return (
            <div className='responsivecontainer'>
                ...
                <a><i><font size="2">Last updated Friday, September 4 at 5:26pm.</font></i></a>
                    ...
                    <div>
                        <BrowserView>
                            ...
                            <ResponsiveContainer width='65%' height='65%' aspect='2.2'>
                                <ComposedChart data={activedata} margin={{ top: 0, right: 0, bottom: 0, left: 0 }}>
                                    <CartesianGrid />
                        ...
                        <MobileView>
                            ...
                            <ResponsiveContainer width={'99%'} height={'65%'} aspect='1'>
                                <ComposedChart data={activedata} margin={{ top: 0, right: 20, bottom: 0, left: -10 }}>
                                    <CartesianGrid />
