...
var siteupdatetime = "Last updated Wednesday, October 7 at 5:15pm CST."
                        ...
                        <Grid item xs>
                            ...
                            <p><font size={isMobile ? (3) : (4)}>
                                <div className="adjustabletext">
                                    ...
                                    Since the majority of COVID illnesses are considered "recovered" 12 days from first symptoms or test date, we assume these cases began on Sept 2. 
                            ...
                            <p><font size={isMobile ? (3) : (4)}>
                                <div className="adjustabletext">
                                    ...
                                    That means some of those cases may have recovered on Sept 12 or Sept 13, which means they actually started Aug 31 or Sept 1. 
                                </div>
                            </font></p>

                            <h5 style={{ marginBottom: -10, marginTop: 5 }}>
                                <div className="adjustabletext">
                                    Why don't the 12 most recent days have bars?
                                </div>
                            </h5>
                            <p><font size={isMobile ? (3) : (4)}>
                                <div className="adjustabletext">
                                    We (you and I) only know the number of illnesses that started during this time by counting 12 days backward once they've recovered. 
                                    Since the cases that started in the past 12 days have not recovered yet, we don't know how many cases started during that time. 
